...
[![Download](https://img.shields.io/crates/d/preexplorer)](https://crates.io/crates/{{project-name}})
[![License](https://img.shields.io/crates/l/preexplorer)](https://github.com/saona-raimundo/{{project-name}})
[![Docs](https://docs.rs/preexplorer/badge.svg)](https://docs.rs/{{project-name}}/)
[![Crate](https://img.shields.io/crates/v/preexplorer.svg)](https://crates.io/crates/{{project-name}})
